...
* status = #draft
* kind = #operation
* description = "Search for a GreekPatientProfile by AMKA extension value. Returns a single Patient resource if found."
* code = #search-by-amka
...
* type = true
* instance = false
* outputProfile = "https://hl7.org/fhir/StructureDefinition/GreekPatientProfile"
* parameter.name = #amka
* parameter.use = #in
* parameter.min = 0
* parameter.max = "1"
